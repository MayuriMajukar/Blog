...
$db = mysqli_connect('localhost', 'root', '', 'blogger') or die("could not connect to database");
...
if(isset($_POST['post_blog'])){
	...
	$query= "INSERT INTO blogs(title,description,bloger_id) VALUES ('$title', '$description',$userid)";
